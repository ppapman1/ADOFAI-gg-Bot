    ...
    handler: async interaction => {
        return interaction.reply(
            lang.langByLangName(interaction.dbUser.lang, 'BOT_INVITE')
                .replace('{minperm}', `https://discord.com/api/oauth2/authorize?client_id=${interaction.client.user.id}&permissions=${setting.INVITE_PERMISSION}&scope=bot%20applications.commands`)
