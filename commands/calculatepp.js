...
module.exports = {
    info: {
        ...
        options: [
            ...
            {
                name: 'accuracy',
                description: '정확도입니다. 모른다면 -1 // This is accuracy. If you don\'t know this, enter -1',
                type: 'NUMBER',
				required: true
            },
            {
    ...
    handler: async interaction => {
		...
		let accuracyV2 = accuracy/(100+(level.tiles*0.01));
		if(accuracy == -1) accuracy = 93.00;
        ...
        return interaction.editReply({
			embeds: [
				new MessageEmbed()
					...
					.addField(lang.langByLangName(interaction.dbUser.lang, 'ACCURACY'), lang.langByLangName(interaction.dbUser.lang, 'ACCURACY_FIELD_VALUE').replace('{accuracy}', accuracy).replace('{maxaccuracy}', (100+(level.tiles*0.01))), true)
